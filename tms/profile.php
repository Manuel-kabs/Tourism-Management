...
<html>
<head>
<title>GTMS |Ghana Tourism Management System</title>
...
<script src="js/wow.min.js"></script>
  ...
  <style>
	.banner-1 {
    background: url(../tms/admin/pacakgeimages/packageimage.webp)no-repeat;
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">GTMS-Ghana Tourism Management System</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
